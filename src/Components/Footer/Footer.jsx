                ...
                <div className="footerCard flex">
                    <div className="footerIntro flex">
                        ...
                        <div data-aos="fade-up" className="footerPara">
                            Lorem ipsum, dolor sit amet consectetur adipisicing elit. Temporibus nesciunt facere dolorem numquam. Aspernatur saepe eaque ad eum soluta tempore veniam voluptatibus, possimus alias modi adipisci maiores ea molestias nobis.
                        </div>
                    ...
                    <div className="footerLinks grid">
                            ...
                            <div data-aos="fade-up" data-aos-duration="5000" className="linkGroup">
                                ...
                                <li className="footerList flex">
                                    <FiChevronRight className="icon" /> Turkey
                                </li>
                            </div>
                    </div>
